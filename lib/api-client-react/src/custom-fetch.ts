...
/**
 * Register a getter that supplies extra headers (e.g. x-user-id, x-user-usn)
 * to be attached to every request.
 */
...
export async function customFetch<T = unknown>(
  ...
  // Attach extra headers (e.g. x-user-id, x-user-usn) from a registered getter.
